...
if (isset($_POST['sub'])) {
	...
	for ($i=0; $i < $count; $i++) {  
		...
		$semester=$_POST['student_id'];
		$attendance=$_POST['attendance'];
		$date=date("d-m-y");
		$que="insert into student_attendance(course_code,subject_code,semester,student_id,attendance,attendance_date)values('$course_code','$subject_code','$semester','$attendance','$date')";
